...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://bimertech.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Blog, Bimer', // 网站关键词 英文逗号隔开
  ...
  WIDGET_PET_LINK:
        ...
        'https://raw.github.com/imuncle/live2d/blob/master/model/xiaomai/xiaomai.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
